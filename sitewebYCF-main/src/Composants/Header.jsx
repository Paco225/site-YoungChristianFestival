...
const Header = () => {
    ...
    return (
        <nav className=" bg-clip  bg-gradient-to-l from-[#650d4e] to-[#031179] h-19 px-6  md:px-20 md:py-6 w-full fixed top-0 z-40">
            <div className="flex justify-between items-center my-[-8px] ">
                ...
                <a href="# "> <button className="hidden md:block bg-transparent border hover:bg-[#2020d6] text-white font-semibold py-2 px-4 rounded">
                    CHAT WHATSAPP
                </button></a>
